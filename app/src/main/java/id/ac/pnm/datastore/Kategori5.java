...
public class Kategori5 extends AppCompatActivity {
    ...
    private RecyclerView snack;

    ProgressDialog pd;
    private RequestQueue requestQueue;
    private StringRequest stringRequest;
    ImageButton btnSearchKat5;
    EditText search_kategori5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kategori5);

        search_kategori5 = (EditText) findViewById(R.id.search_kategori5);

        requestQueue = Volley.newRequestQueue(Kategori5.this);
        pd = new ProgressDialog(Kategori5.this);
        pd.setMessage("Mencari");

        snack = (RecyclerView) findViewById(R.id.snack);
        LinearLayoutManager llm = new LinearLayoutManager(this);
        llm.setOrientation(LinearLayoutManager.VERTICAL);
        snack.setLayoutManager(llm);
        ...
        btnSearchKat5 = (ImageButton) findViewById(R.id.btnSearchKat5);
        btnSearchKat5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pd.show();
                list_data.clear();
                SearchAll = search_kategori5.getText().toString().toLowerCase();
    ...
    private void jsonParse() {
        ...
        stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                ...
                try {
                    ...
                    for (int a = 0; a < jsonArray.length(); a++) {
                        ...
                        if (kategori.equals(kategorinya)) {
                            ...
                            list_data.add(map);
                            pd.dismiss();
                            AdapterList adapter = new AdapterList(Kategori5.this, list_data);
                            snack.setAdapter(adapter);
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Kategori5.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
